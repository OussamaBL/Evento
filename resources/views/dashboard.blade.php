                ...
                <div class="flex-auto p-6 px-0 pb-2">
                    ...
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        ...
                        <tr>
                            ...
                            <div class="flex px-2 py-1">
                                <div>
                                <img src="{{ asset('assets/img/small-logos/logo-jira.svg') }} " class="inline-flex items-center justify-center mr-4 text-white transition-all duration-200 ease-soft-in-out text-sm h-9 w-9 rounded-xl" alt="jira" />
                                </div>
                                <div class="flex flex-col justify-center">
                        ...
                        <tr>
                            ...
                            <div class="flex px-2 py-1">
                                <div>
                                <img src="{{ asset('assets/img/small-logos/logo-invision.svg') }} " class="inline-flex items-center justify-center mr-4 text-white transition-all duration-200 ease-soft-in-out text-sm h-9 w-9 rounded-xl" alt="invision" />
                                </div>
                                <div class="flex flex-col justify-center">
