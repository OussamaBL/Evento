                ...
                <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                    ...
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <form action="{{route('dashboard.categories.store')}}" method="POST" class="w-full max-w-lg">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                              <div class="w-full px-3">
                                <button type="submit" class="px-6 py-2.5 rounded-full text-white text-sm tracking-wider font-semibold border-none outline-none bg-green-600 hover:bg-green-700 active:bg-green-600">Add</button>
                              </div>
                            </div>
                        </form>
                    </div>
